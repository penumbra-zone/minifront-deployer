import{aB as we,aC as ue,aD as pe,a8 as f,aa as _,ab as g,ac as a,aE as L,a9 as re,ax as se,ai as l,av as v,ak as X,ap as me,aF as k,al as he,ah as oe,aG as G,as as h,af as E,ad as q,aH as ae,ar as A,ae as U,aq as ve,aI as fe,ag as ge,an as be}from"./index-BegniEvH.js";import{c as u,n as w,r as d,o as F,U as ye}from"./index-DxLR8ptB.js";const m=we({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),O={state:m,subscribe(s){return pe(m,()=>s(m))},subscribeKey(s,e){return ue(m,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){m.open=!0,m.message=s,m.triggerRect=e,m.variant=t},hide(){m.open=!1,m.message="",m.triggerRect={width:0,height:0,top:0,left:0}}},xe=f`
  :host {
    display: block;
